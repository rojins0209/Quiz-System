...
public class mainpage {
    ...
    public void mainPageView(int id) throws SQLException {
        ...
        start.setFont(new Font("Space Mono", Font.BOLD, 40));
        addPanel.add(start);

        JButton next = new JButton("ADD QUESTION");
        next.setBounds(50, 440, 450, 35);
        addPanel.add(next);
        next.setFont(new Font("Space Mono",Font.PLAIN, 18));
        ...
        addPanel.add(cancel);
        cancel.setFont(new Font("Space Mono",Font.PLAIN, 18));
        ...
        table.setBackground(Color.decode("#FFD1E3"));
        ...
        delete.setFont(new Font("Space Mono",Font.PLAIN, 18));
        ...
        viewPrev.setFont(new Font("Space Mono",Font.PLAIN, 18));
        viewPrev.setBackground(Color.BLACK);
        viewPrev.setForeground(Color.WHITE);
        viewPrev.setFocusable(false);
        ...
        viewNext.setFont(new Font("Space Mono",Font.PLAIN, 18));
        viewNext.setBackground(Color.BLACK);
        viewNext.setForeground(Color.WHITE);
        viewNext.setFocusable(false);
        ...
        addSurvey.setFont(new Font("Space Mono",Font.PLAIN, 18));
        addSurvey.setBackground(Color.BLACK);
        addSurvey.setForeground(Color.WHITE);
        addSurvey.setFocusable(false);
        ...
        viewSurvey.setFont(new Font("Space Mono",Font.PLAIN, 18));
        viewSurvey.setBackground(Color.BLACK);
        ...
        logout.setFont(new Font("Space Mono",Font.PLAIN, 18));
